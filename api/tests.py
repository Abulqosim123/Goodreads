...
class BookReviewAPITestCase(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create_user(username='Admin', first_name='Abulqosim')
    ...
    def test_book_review_detail(self):
        ...
        self.assertEqual(response.data['book']['isb'], '6252525')
        self.assertEqual(response.data['user']['id'], self.user.id)
        self.assertEqual(response.data['user']['first_name'], 'Abulqosim')
